 ...
 */
public class HcmailChoosePersonnelActivity extends HcBaseActivity implements HcChooseHomeView.OnOperatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hcmail_activity_choose_personnel);
    ...
    private class ListRequest extends AbstractHttpRequest {
        ...
        private static final String TAG = HcmailChoosePersonnelActivity.TAG + "ListRequest";
    ...
    public void onParentItemClick(ItemInfo info) {
        ...
        if (HcUtil.isNetWorkAvailable(HcmailChoosePersonnelActivity.this)) {
    ...
    private class DempListResponse extends AbstractHttpResponse {
        ...
        private static final String TAG = HcmailChoosePersonnelActivity.TAG + "$ChoosePersonnelResponse";
        ...
        public void onAccountExcluded(String data, String msg, RequestCategory category) {
            HcDialog.deleteProgressDialog();
            HcUtil.reLogining(data, HcmailChoosePersonnelActivity.this, msg);
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    if (mObserver != null)
