...
public class RefreshManager {
    ...
    public boolean refreshMailboxList(long accountId) {
        ...
        HcLog.D(TAG + "#refreshMailboxList " + accountId);
    ...
    private boolean refreshMessageList(long accountId, long mailboxId, boolean loadMoreMessages,
        ...
        HcLog.D(EmailUtils.DEBUG, TAG + "#refreshMessageList accountId = " + accountId + ", mailboxId = " + mailboxId + ", loadMoreMessages="
                + loadMoreMessages);
    ...
    public boolean sendPendingMessages(long accountId) {
        HcLog.D(TAG + "#sendPendingMessages " + accountId);
    ...
    public void sendPendingMessagesForAllAccounts() {
        HcLog.D(TAG + "#sendPendingMessagesForAllAccounts");
    ...
    private class ControllerResult extends Controller.Result {
        ...
        public void updateMailboxListCallback(MessagingException exception, long accountId,
                int progress) {
            HcLog.D(EmailUtils.DEBUG, TAG + "$ControllerResult#updateMailboxListCallback accountId=" + accountId + ", progress =" + progress
        ...
        public void updateMailboxCallback(MessagingException exception, long accountId,
            ...
            HcLog.D(EmailUtils.DEBUG, TAG + "$ControllerResult#updateMailboxCallback accountId=" + accountId + ", mailboxId="
                    + mailboxId + ", progress = " + progress + ", exception = " + exceptionToString(exception));
        ...
        public void serviceCheckMailCallback(
                ...
                long tag) {
            HcLog.D(EmailUtils.DEBUG, TAG + "$ControllerResult#serviceCheckMailCallback accountId =" + accountId + ", mailboxId="
                    + mailboxId + ", progress = " + progress + ", exception = " + exceptionToString(exception));
            updateMailboxCallbackInternal(exception, accountId, mailboxId, progress, 0);
        }
        ...
        public void sendMailCallback(MessagingException exception, long accountId, long messageId,
                int progress) {
            HcLog.D(EmailUtils.DEBUG, TAG + "#sendMailCallback accountId = " + accountId + ", messageId = "
                    + messageId + ", progress = " + progress + ", exception=" + exceptionToString(exception));
