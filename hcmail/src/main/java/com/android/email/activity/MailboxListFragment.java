...
//    @VisibleForTesting
    ...
    private void startLoading(long parentMailboxId, long highlightedMailboxId) {
        HcLog.D(EmailUtils.DEBUG, "MailboxListFragment# startLoading  parent=" + parentMailboxId
    ...
    private class MailboxListLoaderCallbacks implements LoaderCallbacks<Cursor> {
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            HcLog.D(MailboxListFragment.this + " onCreateLoader");
            mIsFirstLoad = true;
            if (getAccountId() == Account.ACCOUNT_ID_COMBINED_VIEW) {
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
            HcLog.D(MailboxListFragment.this + "MailboxListFragment# onLoadFinished  count="
                    + cursor.getCount());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long doNotUse) {
        HcLog.D(TAG + " #onItemClick!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! position = "+position);
