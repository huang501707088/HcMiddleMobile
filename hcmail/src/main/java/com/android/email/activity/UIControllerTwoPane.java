...
//    @VisibleForTesting
    ...
    public int getLayoutId() {
        HcLog.D(EmailUtils.DEBUG, "UIControllerTwoPane#getLayoutId layoutId = "+R.layout.email_activity_two_pane +
            " include Id = "+ R.layout.three_pane);
    ...
    public void onMailboxSelected(long accountId, long mailboxId, boolean nestedNavigation) {
        HcLog.D(EmailUtils.DEBUG, "UIControllerTwoPane #onMailboxSelected accountId = "+accountId + " mailboxId ="+mailboxId + " nestedNavigation ="+nestedNavigation);
        setListContext(MessageListContext.forMailbox(accountId, mailboxId));
        HcLog.D(EmailUtils.DEBUG, "UIControllerTwoPane #onMailboxSelected getMessageListMailboxId = "+getMessageListMailboxId() + " mListContext.getMailboxId ="+mListContext.getMailboxId());
