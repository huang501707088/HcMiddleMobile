...
public class ThreePaneLayout extends LinearLayout {
    ...
    private void initView() {
        ...
        HcLog.D(EmailUtils.DEBUG, "ThreePaneLayout#initView !!!!!!!!!!!!!!!!");
    }
    ...
    protected void onFinishInflate() {
        HcLog.D(EmailUtils.DEBUG, "ThreePaneLayout#onFinishInflate start!!!!!!!!!!!!!!!!");
        super.onFinishInflate();
        HcLog.D(EmailUtils.DEBUG, "ThreePaneLayout#onFinishInflate system end!!!!!!!!!!!!!!!!");
        ...
        mConvViewExpandList = resources.getBoolean(R.bool.expand_middle_view);
        ...
        mMailboxListWidth = resources.getDimensionPixelSize(
                R.dimen.mailbox_list_width);
        mMessageListWidth = resources.getDimensionPixelSize(R.dimen.message_list_width);
        HcLog.D(EmailUtils.DEBUG, "ThreePaneLayout#onFinishInflate end!!!!!!!!!!!!!!!!");
    }
