 ...
 */
public abstract class UIControllerBase implements MailboxListFragment.Callback,
    ...
    public final void switchAccount(long accountId, boolean forceShowInbox) {
        ...
        if (accountId == Account.ACCOUNT_ID_COMBINED_VIEW) {
            ...
            if (inboxId == Mailbox.NO_MAILBOX) {
                ...
                // the initial sync...
                HcLog.D(EmailUtils.DEBUG, "UIControllerBase #switchAccount Account " + accountId +" doesn't have Inbox.  Redirecting"
                        + " to Welcome...");
//                Welcome.actionOpenAccountInbox(mActivity, accountId);
    ...
    protected final void openMailbox(long accountId, long mailboxId) {
        HcLog.D(EmailUtils.DEBUG, "UIControllerBase#openMailbox accountId = "+accountId + " mailboxId = "+mailboxId);
    ...
    protected void setListContext(MessageListContext listContext) {
        if (HcUtil.equal(listContext, mListContext)) {
            return;
        }
    ...
    public boolean onPrepareOptionsMenu(MenuInflater inflater, Menu menu) {
        ...
        boolean showSearchIcon = accountSearchable && mailboxHasServerCounterpart;
    ...
    public void onMailboxNotFound(boolean isFirstLoad) {
        ...
        long accountId = getUIAccountId();
        HcLog.D(EmailUtils.DEBUG, "UIControllerBase #onMailboxNotFound isFirstLoad ="+isFirstLoad + " accountId = "+accountId);
...
//        }
    ...
    private void updateMessageOrderManager() {
        ...
        HcUtil.checkNotNull(mListContext);
