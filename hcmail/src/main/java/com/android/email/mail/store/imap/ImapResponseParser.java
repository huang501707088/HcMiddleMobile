...
//        }
    ...
    private static IOException newEOSException() {
        ...
        HcLog.D(EmailUtils.DEBUG, "ImapResponseParser #newEOSException " + message);
    ...
    public ImapResponse readResponse() throws IOException, MessagingException {
        ...
        try {
            ...
            HcLog.D(EmailUtils.DEBUG, "ImapResponseParse#readResponse<<< " + response.toString());
        ...
        if (response.is(0, ImapConstants.BYE)) {
            HcLog.D(EmailUtils.DEBUG, "ImapResponseParse#readResponse " + ByeException.MESSAGE);
            response.destroy();
    ...
    private void onParseError(Exception e) {
        ...
        HcLog.D(EmailUtils.DEBUG, "ImapResponseParse#onParseError Exception detected: " + e.getMessage());
