...
class ImapFolder extends Folder {
    ...
    public boolean exists() throws MessagingException {
        HcLog.D(EmailUtils.DEBUG, "ImapFolder#exists start !!!!!!!!!!!!!!!!! mExists = "+mExists);
        if (mExists) {
            return true;
        }
        /*
    ...
    public boolean create(FolderType type) throws MessagingException {
        HcLog.D(EmailUtils.DEBUG, "ImapFolder#create start !!!!!!!!!!!!!!!!! FolderType = "+type);
        /*
         * This method needs to operate in the unselected mode as well as the selected mode
         * so we must get the connection ourselves if it's not there. We are specifically
         * not calling checkOpen() since we don't care if the folder is open.
    ...
    public void copyMessages(Message[] messages, Folder folder,
        ...
        HcLog.D(EmailUtils.DEBUG, "ImapFolder#copyMessages start !!!!!!!!!!!!!!!!!");
        checkOpen();
        try {
    ...
    public int getUnreadMessageCount() throws MessagingException {
        HcLog.D(EmailUtils.DEBUG, "ImapFolder#getUnreadMessageCount start !!!!!!!!!!!!!!!!!");
        checkOpen();
        try {
...
//    @VisibleForTesting
    ...
    public void appendMessages(Message[] messages) throws MessagingException {
        HcLog.D(EmailUtils.DEBUG, "ImapFolder#appendMessages start !!!!!!!!!!!!!!!!!");
        checkOpen();
        try {
    ...
    private void doSelect() throws IOException, MessagingException {
        HcLog.D(EmailUtils.DEBUG, "ImapFolder#doSelect start !!!!!!!!!!!!!!!!!");
