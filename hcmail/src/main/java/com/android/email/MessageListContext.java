...
public class MessageListContext implements Parcelable {
    ...
    public static MessageListContext forMailbox(long accountId, long mailboxId) {
        HcUtil.checkArgument(accountId != Account.NO_ACCOUNT, "Must specify an account");
        HcUtil.checkArgument(mailboxId != Mailbox.NO_MAILBOX, "Must specify a mailbox");
    ...
    public boolean equals(Object o) {
        ...
        return mAccountId == om.mAccountId
                ...
                && HcUtil.equal(mSearchParams, om.mSearchParams);
    }

    @Override
    public int hashCode() {
        return HcUtil.hashCode(mAccountId, mMailboxId, mSearchParams);
    }
