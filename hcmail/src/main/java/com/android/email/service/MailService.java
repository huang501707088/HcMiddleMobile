...
//    @VisibleForTesting
    ...
    class ControllerResults extends Controller.Result {
        ...
        public void updateMailboxCallback(MessagingException result, long accountId,
           ...
           //checkAuthenticationStatus(result, accountId);
            HcLog.D(EmailUtils.DEBUG, "MailService$ControllerResults#updateMailboxCallback result = "+result + " accountId = "+accountId
                + " mailboxId = "+mailboxId + " progress = "+progress + " numNewMessages = "+numNewMessages + " addedMessages = "+addedMessages.toString());
        ...
        public void serviceCheckMailCallback(MessagingException result, long accountId,
            ...
            HcLog.D(EmailUtils.DEBUG, "MailService$ControllerResults#updateMailboxCallback result = "+result + " accountId = "+accountId
                    + " mailboxId = "+mailboxId + " progress = "+progress + " mailboxId ="+mailboxId + " tag = "+tag);
            if (result != null || progress == 100) {
                if (result != null) {
    ...
    public static ArrayList<Account> getPopImapAccountList(Context context) {
        ...
        Log.d(LOG_TAG, " #getPopImapAccountList account url = "+Account.CONTENT_URI.toString());
