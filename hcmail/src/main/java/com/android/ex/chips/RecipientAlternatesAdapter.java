...
public class RecipientAlternatesAdapter extends CursorAdapter {
    ...
    public static HashMap<String, RecipientEntry> getMatchingRecipients(Context context,
        ...
        Cursor c = context.getContentResolver().query(
                query.getContentUri(),
                query.getProjection(),
                query.getProjection()[Query.DESTINATION] + " IN (" + bindString.toString()
                        + ")", addresses, null);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (position == 0) {
            display.setText(cursor.getString(Query.NAME));
        ...
        destination.setText(cursor.getString(Query.DESTINATION));
        ...
        if (destinationType != null) {
            destinationType.setText(mQuery.getTypeLabel(context.getResources(),
                    cursor.getInt(Query.DESTINATION_TYPE),
                    cursor.getString(Query.DESTINATION_LABEL)).toString().toUpperCase());
        }
    }
