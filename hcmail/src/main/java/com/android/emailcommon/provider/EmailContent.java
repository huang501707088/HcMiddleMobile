...
public abstract class EmailContent {
    ...
    public static final String AUTHORITY = HcProvider.DEFAULT_AUTHORITY + ".email.provider";//"com.android.hcframe.email.provider";
    ...
    public static final String NOTIFIER_AUTHORITY = HcProvider.DEFAULT_AUTHORITY + ".email.notifier";//"com.android.hcframe.email.notifier";
...
//        @VisibleForTesting
    ...
    public interface MessageColumns {
        ...
        // 发件箱邮件的状态 0：等待;1:发送中;2:发送失败;3:发送成功
    ...
    public static final class Message extends EmailContent implements SyncColumns, MessageColumns {
        ...
        public static final int CONTENT_OUTBOX_STATUS_COLUMN = 24;
        ...
        public static final String[] CONTENT_PROJECTION = new String[] {
            ...
            MessageColumns.THREAD_TOPIC, MessageColumns.OUTBOX_STATUS
        };
        ...
        public ContentValues toContentValues() {
            ...
            values.put(MessageColumns.OUTBOX_STATUS, mOutboxStatus);
            return values;
        }
        ...
        public void restore(Cursor cursor) {
            ...
            mOutboxStatus = cursor.getInt(CONTENT_OUTBOX_STATUS_COLUMN);
        }
        ...
        public static String buildMessageListSelection(
            ...
            String slelctions = selection.toString();
            HcLog.D(EmailUtils.DEBUG, "EmailContent #buildMessageListSelection selection = "+slelctions);
            return slelctions;
        }
    }
