...
import com.android.hcframe.im.OnSendListener;
...
public class XMPPConnection extends Connection {
    ...
    public void disconnect(Presence unavailablePresence) {
        ...
        packetWriter = null;
        packetReader.cleanup(); // 这里会把接收消息的listener清空,包括ChatManager构造方法里面添加的监听
        packetReader = null;

        chatManager = null; // 这里需要详细测试
    }
    ...
    private void initConnection() throws XMPPException {
        ...
        HcLog.D("XMPPConnection#initConnection!!!!!!!!!!!!!!!!!!! isFirstInitialization ="+isFirstInitialization);
        ...
        try {
            ...
            if (isFirstInitialization) {
                HcLog.D("XMPPConnection#initConnection!!!!!!!!!!!!!!!!!!! Listener size  ="+getConnectionCreationListeners().size());
    ...
    public void connect() throws XMPPException {
        ...
        if (connected && wasAuthenticated) {
            // Make the login
            HcLog.D("XMPPConnection #connect 连接创建成功开始自动登录！！！！！！！！");
            try {
                if (isAnonymous()) {
    ...
    private List<OnSendListener> mSendListeners = new ArrayList<OnSendListener>();

    public void addSendListener(OnSendListener listener) {
        if (!mSendListeners.contains(listener))
    ...
    public List<OnSendListener> getSendListeners() {
