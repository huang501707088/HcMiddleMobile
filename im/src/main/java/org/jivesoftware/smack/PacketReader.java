...
public class PacketReader {
    ...
    public void shutdown() {
        ...
        if (!done) {
            ...
            connection.connectionListeners.clear();
        }
        done = true;
    ...
    private void parsePackets(Thread thread) {
        HcLog.D("PacketReader#parsePackets start!!!!!!!!!!!!!!!!!!!!!!!!!!! thread======"+thread);
        try {
            int eventType = parser.getEventType();
            do {
//                HcLog.D("PacketReader#parsePackets!!!!!!!!!!!!!!!!!!!!!!!!!!! do do do thread======"+thread);
            ...
            HcLog.D("PacketReader#parsePackets end end end !!!!!!!!!!!!!!!!!!!!!!!!!!! thread======"+thread);
        }
        catch (Exception e) {
            if (!done) {
