    ...
    protected void initDebugger() {
        ...
        if (config.isDebuggerEnabled()) {
            if (debugger == null) {
                ...
                HcLog.D("Connection #initDebugger debuggerClass = "+debuggerClass);
...
//            HcLog.D("Connection#notifyListener !!!!!!!!!!!!!!!!!!!!!!!!!!!!! packet = "+packet + " listener = "+packetListener);
//            for (PacketExtension element : packet.getExtensions()) {
//                HcLog.D("Connection#notifyListener !!!!" + " name = "+element.getElementName() + " namespace = "+element.getNamespace());
//            }
//            if (packetFilter != null) {
//                HcLog.D("Connection#notifyListener !!!!!!!!!!!!!!!!!!!!!!!!!!!!! packet accept = "+packetFilter.accept(packet) + " listener = "+packetListener);
//            }
