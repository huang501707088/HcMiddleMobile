...
public class Chat {
    ...
    public void sendMessage(String text) throws XMPPException {
        ...
        HcLog.D("Chat#sendMessage message id = "+message.getPacketID());
     ...
     * @throws XMPPException if sending the message fails.
     */
    public void sendMediaMessage(String text, String attachment, String type, String duration) throws XMPPException {
        Message message = new Message(participant, Message.Type.chat);
        message.setThread(threadID);
        message.setBody(text);
    ...
    /**
     * Sends the specified text as a message to the group chat participant.
     * This is a convenience method for:
     *
     * <pre>
     *     Message message = chat.createMessage();
     ...
     * @throws XMPPException if sending the message fails.
     */
    public void sendGroupMessage(String text, String userId) throws XMPPException {
        Message message = new Message(participant, Message.Type.groupchat);
        message.setThread(threadID);
        message.setBody(text);
    ...
    /**
     * Sends a message to the group chat participant. The thread ID, recipient,
     * and message type of the message will automatically set to those of this chat.
     *
     * @param message the message to send.
     * @throws XMPPException if an error occurs sending the message.
     */
    public void sendGroupMessage(Message message) throws XMPPException {
        // Force the recipient, message type, and thread ID since the user elected
        // to send the message through this chat object.
        message.setTo(participant);
     ...
     * @throws XMPPException if sending the message fails.
     */
    public void sendGroupMediaMessage(String text, String attachment, String type, String duration, String userId) throws XMPPException {
        Message message = new Message(participant, Message.Type.groupchat);
        message.setThread(threadID);
        message.setBody(text);
        message.setMediaType(type);
     ...
     * @throws XMPPException if an error occurs sending the message.
     */
    public void sendMediaMessage(Message message) throws XMPPException {
        // Force the recipient, message type, and thread ID since the user elected
        // to send the message through this chat object.
        message.setTo(participant);
        message.setType(Message.Type.chat);
        message.setThread(threadID);
        HcLog.D("Chat#sendMediaMessage message id = "+message.getPacketID());
        chatManager.sendMessage(this, message);
    }
     ...
     * @throws XMPPException if an error occurs sending the message.
     */
    public void sendGroupMediaMessage(Message message) throws XMPPException {
        // Force the recipient, message type, and thread ID since the user elected
        // to send the message through this chat object.
        message.setTo(participant);
        message.setType(Message.Type.groupchat);
     ...
     * @throws XMPPException if an error occurs sending the message.
     */
    public void sendSystemMessage(Message message) throws XMPPException {
        // Force the recipient, message type, and thread ID since the user elected
        // to send the message through this chat object.
        message.setTo(participant);
        message.setType(Message.Type.normal);
        message.setThread(threadID);
        HcLog.D("Chat#sendSystemMessage message id = "+message.getPacketID());
        chatManager.sendMessage(this, message);
    }
}