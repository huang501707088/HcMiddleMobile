...
public class Message extends Packet {
    ...
    private String mAttachment; // 文件64base编码

    private String mDuration; // 音频的时长

    private String mUserId; // 用于群聊,发送方的userId

    private String mReceiver; // 用于群聊,@的对象的userId,多个对象用";"隔开
    ...
    public String toXML() {
        ...
        if (mAttachment != null) {
            buf.append("<attachment>").append(mAttachment).append("</attachment>");
        }
        if (mMediaType != null) {
            buf.append("<chatType>").append(mMediaType).append("</chatType>");
        }
        if (mDuration != null) {
            buf.append("<duration>").append(mDuration).append("</duration>");
        }
        if (mUserId != null) {
            buf.append("<userId>").append(mUserId).append("</userId>");
        }
        if (mReceiver != null) {
            buf.append("<receiver>").append(mReceiver).append("</receiver>");
        }
        if (thread != null) {
    ...
    public boolean equals(Object o) {
        ...
        if (mAttachment != null ? !mAttachment.equals(message.mAttachment) : message.mAttachment != null) {
            return false;
        }
        if (mMediaType != null ? !mMediaType.equals(message.mMediaType) : message.mMediaType != null) {
            return false;
        }
        if (mDuration != null ? !mDuration.equals(message.mDuration) : message.mDuration != null) {
            return false;
        }
        if (mUserId != null ? !mUserId.equals(message.mUserId) : message.mUserId != null) {
            return false;
        }
        if (mReceiver != null ? !mReceiver.equals(message.mReceiver) : message.mReceiver != null) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (mAttachment != null ? mAttachment.hashCode() : 0);
    ...
    public String getMediaType() {
        HcLog.D("Message #getMediaType mediaType = "+mMediaType);
        return mMediaType;
    }

    public void setMediaType(String mediaType) {
        HcLog.D("Message #setMediaType mediaType = "+mediaType);
