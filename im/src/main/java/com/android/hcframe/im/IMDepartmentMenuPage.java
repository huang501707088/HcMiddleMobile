 ...
 * Created by jrjin on 16-8-29 14:51.
 */
public class IMDepartmentMenuPage extends MenuPage {

    @Override
    public AbstractPage createPage(String appId, Activity context, ViewGroup parent) {
        return new ContactPage(context, parent, appId, ContactPage.DataType.DEPARTEMT_SUB, true);
    }
}
