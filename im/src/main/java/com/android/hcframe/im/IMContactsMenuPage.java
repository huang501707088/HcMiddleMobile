 ...
 * Created by jrjin on 16-8-29 14:44.
 */

/**
 * 启动全部的联系人界面
 */
public class IMContactsMenuPage extends MenuPage {

    @Override
    public AbstractPage createPage(String appId, Activity context, ViewGroup parent) {
        return new ContactPage(context, parent, appId, ContactPage.DataType.EMPLOYEE, true);
    }
}
