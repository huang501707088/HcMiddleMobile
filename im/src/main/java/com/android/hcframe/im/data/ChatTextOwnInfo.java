 ...
 * Created by jrjin on 16-9-8 16:41.
 */
public class ChatTextOwnInfo extends ChatMessageInfo{

    public ChatTextOwnInfo() {
        super();
        mType = 1;
        mIsOwn = true;
    }
    ...
    public ViewHolderBase<ChatMessageInfo> createViewHolder(final boolean group) {
        return new ViewHolderBase<ChatMessageInfo>() {
            ...
            public View createView(LayoutInflater inflater) {
                View item = inflater.inflate(R.layout.im_chatting_msg_item_own, null);
                mDate = (TextView) item.findViewById(R.id.chat_item_own_date);
                mContent = (TextView) item.findViewById(R.id.chat_item_own_content);
                mIcon = (ImageView) item.findViewById(R.id.chat_item_own_icon);
                mDivider = item.findViewById(R.id.chat_item_own_divider);
                mProgressBar = (ProgressBar) item.findViewById(R.id.chat_item_own_progress);
                mReSend = (ImageView) item.findViewById(R.id.chat_item_own_resend);
                return item;
            }
