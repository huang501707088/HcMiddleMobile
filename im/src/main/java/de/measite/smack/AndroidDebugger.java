...
public class AndroidDebugger implements SmackDebugger {
    ...
    private void createDebug() {
        ...
        readerListener = new ReaderListener() {
            public void read(String str) {
            	HcLog.D("AndroidDebugger#read SMACK "+
        ...
        writerListener = new WriterListener() {
            public void write(String str) {
                HcLog.D("AndroidDebugger#write SMACK "+
        ...
        listener = new PacketListener() {
            public void processPacket(Packet packet) {
                if (printInterpreted) {
                    HcLog.D("AndroidDebugger#processPacket SMACK "+
        ...
        connListener = new ConnectionListener() {
            public void connectionClosed() {
                HcLog.D("AndroidDebugger#connectionClosed SMACK "+
            ...
            public void connectionClosedOnError(Exception e) {
                HcLog.D("AndroidDebugger#connectionClosedOnError SMACK "+
            ...
            public void reconnectionFailed(Exception e) {
                HcLog.D("AndroidDebugger#reconnectionFailed SMACK "+
                        dateFormatter.format(new Date()) +
            ...
            public void reconnectionSuccessful() {
                HcLog.D("AndroidDebugger#reconnectionSuccessful SMACK "+
                        dateFormatter.format(new Date()) + " Connection reconnected (" +
                        connection.hashCode() +
                        ")");
            }
            public void reconnectingIn(int seconds) {
                HcLog.D("AndroidDebugger#reconnectingIn SMACK "+
    ...
    public void userHasLogged(String user) {
        ...
        HcLog.D("AndroidDebugger#userHasLogged SMACK "+ title);
