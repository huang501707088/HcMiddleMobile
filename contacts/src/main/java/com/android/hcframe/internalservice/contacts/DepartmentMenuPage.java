 ...
 * Created by jrjin on 16-8-28 16:57.
 */
public class DepartmentMenuPage extends MenuPage {

    @Override
    public AbstractPage createPage(String appId, Activity context, ViewGroup parent) {
        return new ContactPage(context, parent, appId, ContactPage.DataType.DEPARTEMT_SUB, false);
    }
}
