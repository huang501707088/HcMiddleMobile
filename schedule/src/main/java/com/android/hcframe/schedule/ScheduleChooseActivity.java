 ...
 */
public class ScheduleChooseActivity extends HcBaseActivity implements HcChooseHomeView.OnOperatorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.schedule_activity_choose);
        mParent = (FrameLayout) findViewById(R.id.schedule_choose_personnel_parent);
