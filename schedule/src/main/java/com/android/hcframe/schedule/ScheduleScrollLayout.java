...
public class ScheduleScrollLayout extends ViewGroup {
    ...
    private ScheduleOnViewChangeListener mOnViewChangeListener;
    ...
    public ScheduleScrollLayout(Context context) {
        super(context);
        Log.i(TAG, "---ScrollLyout1---");
        init(context);
    }

    public ScheduleScrollLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.i(TAG, "---ScrollLyout2---");
        init(context);
    }

    public ScheduleScrollLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        removeViewAt(2);
    ...
    public void SetOnViewChangeListener(ScheduleOnViewChangeListener listener) {
    ...
    public void clickLeftMonth() {
        HcLog.D("clickLeftMonth#mCurScreen = " + mCurScreen);
        mCompleted = true;
        mOrientation = 0;
        snapToScreen(mCurScreen - 1);
    }
