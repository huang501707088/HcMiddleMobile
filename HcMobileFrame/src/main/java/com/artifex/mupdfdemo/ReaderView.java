...
public class ReaderView
	...
	private void measureView(View v) {
		...
		HcLog.D("ReaderView#measureView width = "+v.getWidth() + " height = "+v.getHeight());
		HcLog.D("ReaderView#measureView measure width = "+v.getMeasuredWidth() + " measure height = "+v.getMeasuredHeight());
		v.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
		HcLog.D("ReaderView#measureView after measure! =================================");
		HcLog.D("ReaderView#measureView width = "+v.getWidth() + " height = "+v.getHeight() + " mReflow = " +mReflow);
		HcLog.D("ReaderView#measureView measure width = "+v.getMeasuredWidth() + " measure height = "+v.getMeasuredHeight());
		if (!mReflow) {
		...
		HcLog.D("ReaderView#measureView after scale! =================================");
		HcLog.D("ReaderView#measureView width = "+v.getWidth() + " height = "+v.getHeight() + " mReflow = " +mReflow);
		HcLog.D("ReaderView#measureView measure width = "+v.getMeasuredWidth() + " measure height = "+v.getMeasuredHeight());
	}
