...
public class HcPDFActivity extends HcBaseActivity {
	...
	private RelativeLayout mPdfParent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (core == null) {
			...
			if (Intent.ACTION_VIEW.equals(intent.getAction())) {
				...
				HcLog.D("HcPDFActivity# it is onCreate! uri path = "
						+ uri.toString());
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mTopBarView = (TopBarView) findViewById(R.id.pdf_top_bar);
		mPdfParent = (RelativeLayout) findViewById(R.id.pdf_parent);
		...
		mPdfParent.addView(mDocView);
		mPdfParent.addView(mButtonsView);

		mTopBarView.setTitle(/* mFileName */mTitle);
	}
...
//		 sendBroadcast(new Intent(HcUtil.CLIKC_ACTION));
		if (core != null)
			core.onDestroy();
		if (mAlertTask != null) {
			mAlertTask.cancel(true);
