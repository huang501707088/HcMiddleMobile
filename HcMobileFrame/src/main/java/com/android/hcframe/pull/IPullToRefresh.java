...
import com.android.hcframe.pull.PullToRefreshBase.OnPullEventListener;
...
import com.android.hcframe.pull.PullToRefreshBase.State;
...
public interface IPullToRefresh<T extends View> {
	 ...
	 * @param listener - Listener to be used when the Widget is set to Refresh
	 */
	public void setOnRefreshBothListener(OnRefreshBothListener<T> listener);
