...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	/** 下拉释放后刷新的提示 */
	private String mPullDownRefreshingLable;
	/** 上拉显示的提示 */
	private String mPullUpLable;
	/** 上拉释放的提示 */
	private String mPullUpReleaseLable;
	/** 上拉释放后刷新的提示 */
	private String mPullUpRefreshingLable;
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		if (mResetLable) {
			switch (getCurrentMode()) {
				...
				case PULL_FROM_END:
					if (mPullUpRefreshingLable != null) {
						getFooterLayout().setRefreshingLabel(mPullUpRefreshingLable);
					}
				case PULL_FROM_START:
			    default:
					if (mPullDownRefreshingLable != null) {
						getHeaderLayout().setRefreshingLabel(mPullDownRefreshingLable);
					}
			        break;
			}
		}
		...
		if (mResetLable) {
			switch (getCurrentMode()) {
				...
				case PULL_FROM_END:
					if (mPullUpRefreshingLable != null) {
						listViewLoadingView.setRefreshingLabel(mPullUpRefreshingLable);
					}
				case PULL_FROM_START:
				default:
					if (mPullDownRefreshingLable != null) {
						listViewLoadingView.setRefreshingLabel(mPullDownRefreshingLable);
					}
					break;
			}
		}
	...
	protected void onPullToRefresh() {
		...
		if (mResetLable) {
			...
			case MANUAL_REFRESH_ONLY:
			case PULL_FROM_END:
				if (/*!TextUtils.isEmpty(mPullUpLable)*/mPullUpLable != null) {
					getFooterLayout().setPullLabel(mPullUpLable);
				}
				break;
			case PULL_FROM_START:
			default:
				if (/*!TextUtils.isEmpty(mPullDownLable)*/mPullDownLable != null) {
	...
	protected void onReleaseToRefresh() {
		...
		if (mResetLable) {
			...
			case MANUAL_REFRESH_ONLY:
			case PULL_FROM_END:
				if (/*!TextUtils.isEmpty(mPullUpReleaseLable)*/mPullUpReleaseLable != null) {
					getFooterLayout().setReleaseLabel(mPullUpReleaseLable);
				}
				break;
			case PULL_FROM_START:
			default:
				if (/*!TextUtils.isEmpty(mPullDownReleaseLable)*/mPullDownReleaseLable != null) {
	 ...
	 * @param lable
     */
	public void setPullDownRefreshingLable(String lable) {
		mPullDownRefreshingLable = lable;
		if (null != lable) {
			getHeaderLayout().setRefreshingLabel(lable);
		}
	 ...
	 * @param lable
     */
	public void setPullUpRefreshingLable(String lable) {
		mPullUpRefreshingLable = lable;
		if (null != lable) {
			getFooterLayout().setRefreshingLabel(lable);
		}
	}
}
