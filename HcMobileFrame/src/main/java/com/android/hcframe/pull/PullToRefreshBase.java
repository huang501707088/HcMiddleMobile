...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private OnRefreshBothListener<T> mOnRefreshListener2;
...
//		HcLog.D(" onInterceptTouchEvent mIsBeingDragged ="+mIsBeingDragged + " action = "+event.getAction());
...
//		HcLog.D(" onTouchEvent mIsBeingDragged ="+mIsBeingDragged + " action = "+event.getAction());
		if (!isPullToRefreshEnabled()) {
			return false;
		}
	...
	@Override
	public final void setOnRefreshBothListener(OnRefreshBothListener<T> listener) {
	...
	protected final void onRestoreInstanceState(Parcelable state) {
		if (state instanceof Bundle) {
			...
			HcLog.D("PullToRefreshBase onRestoreInstanceState before!");
			// Let super Restore Itself
			super.onRestoreInstanceState(bundle.getParcelable(STATE_SUPER));
			HcLog.D("PullToRefreshBase onRestoreInstanceState after!");
		...
		HcLog.D("PullToRefreshBase onRestoreInstanceState state ="+state);
	 ...
	 * @author Chris Banes
	 */
	public static interface OnRefreshBothListener<V extends View> {
