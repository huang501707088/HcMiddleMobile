...
public class PersonCenterActivity extends AbsActiviy {
	...
	protected void onInitData() {
		mTopBarView.setTitle(getString(R.string.person_center));
	}

	@Override
	protected void setPameter() {
		menuPage = "com.android.hcframe.pcenter.PersonCenterMenuPage";
	}
