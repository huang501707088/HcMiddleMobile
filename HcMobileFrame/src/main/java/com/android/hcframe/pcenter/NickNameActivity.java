...
public class NickNameActivity extends AbsActiviy {
	...
	protected void onInitData() {
		...
		mTopBarView.setTitle(getString(R.string.modify_nickname));
	}

	@Override
	protected void setPameter() {
		menuPage = "com.android.hcframe.pcenter.NickNameMenuPage";
	}
