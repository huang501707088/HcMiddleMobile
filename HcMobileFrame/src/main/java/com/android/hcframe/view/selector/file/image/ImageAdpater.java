 ...
 */
public class ImageAdpater extends HcBaseAdapter<ImageItemInfo> {
    ...
    public ImageAdpater(Context context, List<ImageItemInfo> infos) {
        super(context, infos);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ImageItemInfo info = getItem(position);
        ViewHolder holder;
        if (convertView == null) {
            holder = new ViewHolder();
            convertView = mInflater.inflate(R.layout.file_image_item_layout, parent, false);
