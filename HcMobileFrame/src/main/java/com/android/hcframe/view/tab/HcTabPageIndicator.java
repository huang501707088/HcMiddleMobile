 ...
 */
public class HcTabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public HcTabPageIndicator(Context context) {
        this(context, null);
    }

    public HcTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (count > mCount) {
                mTabLayout.addView(view, new LinearLayout.LayoutParams(HcUtil.getScreenWidth() / mCount, MATCH_PARENT));
            } else {
                mTabLayout.addView(view, new LinearLayout.LayoutParams(HcUtil.getScreenWidth() / count, MATCH_PARENT));
            }
    ...
    public static interface JumpPager {
        public void jumpPager(int position);
    }

    private JumpPager mJumpPager;

    public void setJumpPager(JumpPager jumpPager) {
        mJumpPager = jumpPager;
    }
}
