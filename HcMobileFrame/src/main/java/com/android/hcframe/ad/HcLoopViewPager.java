 ...
 */
public class HcLoopViewPager extends ViewPager {
    ...
    public void setAdapter(PagerAdapter adapter,boolean canLoop) {
        mAdapter = new LoopPagerAdapterWrapper(adapter,canLoop);
    ...
    public HcLoopViewPager(Context context) {
        super(context);
        init();
    }

    public HcLoopViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageScrollStateChanged(int state) {
            if (mAdapter != null) {
                int position = HcLoopViewPager.super.getCurrentItem();
                int realPosition = mAdapter.toRealPosition(position);
