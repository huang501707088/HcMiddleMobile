 ...
 * Created by jrjin on 16-8-2 16:03.
 */
public class FileAdapter extends HcBaseAdapter<NetdiscAudioInfo> {

    public FileAdapter(Context context, List<NetdiscAudioInfo> infos) {
        super(context, infos);
    }
